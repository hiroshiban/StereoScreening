...
function ms=mseq(baseVal,powerVal,shift,whichSeq,user_taps)
...
%  
% Modification are by Thomas Liu, UCSD Center for fMRI to extend the
%  
%
%  Mods
...
switch powerVal,
 case 2, tap(1).No = [1,4];
 case 3, tap(1).No=[0,1,5];
 case 4, tap(1).No = [0,1,1,4];
 otherwise error(sprintf('M-sequence %.0f^%.0f is not defined',baseVal, ...
			 powerVal))
end  
elseif baseVal==4,
switch powerVal,
 case 2, tap(1).No = [1,2];
 case 3, tap(1).No=[1,1,2];
 case 4, tap(1).No = [1,2,2,2];
 otherwise error(sprintf('M-sequence %.0f^%.0f is not defined',baseVal, ...
			 powerVal))
end  
elseif baseVal==8,
switch powerVal,
 case 2, tap(1).No = [1,2]
 case 3, tap(1).No=[1,0,3];
 case 4, tap(1).No = [1,0,0,5];
 otherwise error(sprintf('M-sequence %.0f^%.0f is not defined',baseVal, ...
			 powerVal))
end  
elseif baseVal==9,
switch powerVal,
 case 2, tap(1).No = [1,3]
 case 3, tap(1).No=[0,1,3];
 case 4, tap(1).No = [1,0,0,6];
 otherwise error(sprintf('M-sequence %.0f^%.0f is not defined',baseVal, ...
			 powerVal))
end  
elseif baseVal==11,
switch powerVal,
 case 2, tap(1).No = [10,4];
         tap(2).No = [12,4];
	 tap(3).No = [1,3];
	 tap(4).No = [3,3];
	 tap(5).No = [8,3];
	 ...
	 tap(17).No = [6,9];
	 tap(18).No = [7,9];
 case 3, tap(1).No=[0,10,7];
 case 4, tap(1).No = [0,0,10,9];
 otherwise error(sprintf('M-sequence %.0f^%.0f is not defined',baseVal, ...
			 powerVal))
end  
elseif baseVal==13,
switch powerVal,
 case 2, tap(1).No = [12,11];
 case 3, tap(1).No=[0,12,7];
 otherwise error(sprintf('M-sequence %.0f^%.0f is not defined',baseVal, ...
			 powerVal))
end  
