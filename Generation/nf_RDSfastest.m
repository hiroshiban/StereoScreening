function [imgL,imgR]=nf_RDSfastest(posL,posR,wdot,bdot,dotalpha,dotDens,bgcolor,skipzero_flg,avoid_bias_flg,use_mex_flg)
...
% Last Update: "2018-02-18 13:05:54 ban"
...
if avoid_bias_flg
  ...
  % -1 is required to match the conventions with my code (negative is near)
  % and with the codes used when avoid_bias_flg=true;
  posL=-1.*posL;
