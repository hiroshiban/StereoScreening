function [imgL,imgR]=nf_RDSfastest_with_acor_noise_MEX(posL,posR,wdot,bdot,dotalpha,dotDens,noise_psc,bgcolor)

% Generates left/right Random-Dot-AntiCorrelated-Stereogram images with noise (MEX-based).
% function [imgL,imgR]=nf_RDSfastest_with_acor_noise(posL,posR,wdot,bdot,dotalpha,dotDens,noise_psc,bgcolor)
%
...
% Last Update: "2018-02-18 12:47:59 ban"
